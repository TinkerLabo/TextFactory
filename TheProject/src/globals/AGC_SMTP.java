...
public class AGC_SMTP extends StaticKeyValue {
	...
	// default value
	// ------------------------------------------------------------------------
	static final String DEFAULT_PORT = "25"; // SMTP接続用ポート番号(25番)
	static final String DEFAULT_HOSTNAME = "AGCSMTP";// "AGCMAIL"; // 送信用サーバ
	// ------------------------------------------------------------------------
	// コンストラクタ
	// ------------------------------------------------------------------------
	public AGC_SMTP() {
