...
public class StripeTableRenderer_org extends DefaultTableCellRenderer {
	...
	private ColorMapCtrl_org colorMapCtrl;

	public void setColorMapList(ColorMapCtrl_org colorMapCtrl) {
	...
	public StripeTableRenderer_org() {
		super();
