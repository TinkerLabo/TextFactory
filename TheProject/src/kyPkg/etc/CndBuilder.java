...
public class CndBuilder {
	...
	public static String getPattern() {
		return "(" + CndBuilder.CONTAINS + "|" + CndBuilder.ENDWITH + "|"
				+ CndBuilder.BEGINWITH + "|" + CndBuilder.EQUALS + ")";
	}
	...
	// コンストラクタ
	// ------------------------------------------------------------------------
	public CndBuilder(String debug, String prefix,
	...
	public String getCondJan(List<String> condList1, List<String> condList2,
		...
		if (condList1 == null )condList1=new ArrayList();   //20170718
		if (condList2 == null )condList2=new ArrayList();   //20170718
//		if (condList1 == null || condList2 == null)
//			return "";
	...
	public String getCond(List<String> condList1, List<String> condList2,
		...
		//		System.out.println("@getCond xWhere1:" + xWhere1);
		//		System.out.println("@getCond xWhere2:" + xWhere2);
	...
	private String parseIt(String relType, List<String> condList) {
		...
		for (String element : condList) {
			...
			if (array != null && array.length >= 3 && !array[1].equals("")) {
				...
				String ope = array[2];
				// fieldTyp = fieldTyp.toUpperCase();// フィールドタイプは大文字に変換する
